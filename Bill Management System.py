...
#DEFINE COST OF EACJ ITEM PER QUANTITY
    ...
    string_bill="Rs.",str("%d" %totalcost)
...
Label(f,font=("Lucida Calligraphy",15,"bold"),text = "Dosa........Rs.60/Plate",bg="lightgreen").place(x=10,y=80)
Label(f,font=("Lucida Calligraphy",15,"bold"),text = "cookies........Rs.30/Plate",bg="lightgreen").place(x=10,y=110)
Label(f,font=("Lucida Calligraphy",15,"bold"),text = "tea........Rs.7/Cup",bg="lightgreen").place(x=10,y=140)
Label(f,font=("Lucida Calligraphy",15,"bold"),text = "Coffee........Rs.100/Cup",bg="lightgreen").place(x=10,y=170)
Label(f,font=("Lucida Calligraphy",15,"bold"),text = "Juice........Rs.20/Glass",bg="lightgreen").place(x=10,y=200)
Label(f,font=("Lucida Calligraphy",15,"bold"),text = "Pancake.....Rs.15/Plate",bg="lightgreen").place(x=10,y=230)
Label(f,font=("Lucida Calligraphy",15,"bold"),text = "Eggs........Rs.7/Piece",bg="lightgreen").place(x=10,y=260)
...
lbl_Pancakes=Label(f1,font=("aria",20,"bold"),text="Pancake",width=12,fg="Blue4")
...
entry_Cookie=Entry(f1,font=("aria",20,"bold"),textvariable=Cookie,bd=6,width=8,bg="lightpink")
